...
Collects, compares, and formats authoritative search contexts for AI generation.
"""
...
def web_search(query: str, max_results: int = 5) -> Dict[str, Any]:
    """
    Executes a real internet search using free SearXNG meta-search engine
    with fallback to open primary search endpoints.
    """
    ...
    # 2. DuckDuckGo / Meta-Search Fallback
    if not results:
        try:
    ...
    # Prioritize Official / Primary Sources (.gov, .edu, wikipedia, investing.com, google, reuters, amazon, etc.)
    OFFICIAL_DOMAINS = ["wikipedia.org", "gov", "edu", "investing.com", "reuters.com", "bloomberg.com", "google.com", "apple.com", "amazon.com", "live-rates.com", "wise.com"]
